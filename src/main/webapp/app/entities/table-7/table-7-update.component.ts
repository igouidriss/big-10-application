...
import { type ITable7, Table7 } from '@/shared/model/table-7.model';
...
export default defineComponent({
  ...
  setup() {
    ...
    const table7: Ref<ITable7> = ref(new Table7());
    ...
    const v$ = useVuelidate(validationRules, table7 as any);
    v$.value.$validate();
      ...
      if (this.table7.id) {
        this.table7Service()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('big10SampleApplicationApp.table7.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.table7Service()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('big10SampleApplicationApp.table7.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
