...
import { Table7 } from '@/shared/model/table-7.model';
...
describe('Service Tests', () => {
  describe('Table7 Service', () => {
    let service: Table7Service;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new Table7Service();
      currentDate = new Date();
      elemDefault = new Table7(
        123,
        0,
        'AAAAAAA',
        0,
    ...
    describe('Service methods', () => {
      ...
      it('should create a Table7', async () => {
        const returnedFromService = Object.assign(
          {
            id: 123,
            dateDebutResv18: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a Table7', async () => {
      ...
      it('should update a Table7', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not update a Table7', async () => {
      ...
      it('should partial update a Table7', async () => {
      ...
      it('should not partial update a Table7', async () => {
      ...
      it('should return a list of Table7', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not return a list of Table7', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a Table7', async () => {
      ...
      it('should not delete a Table7', async () => {
