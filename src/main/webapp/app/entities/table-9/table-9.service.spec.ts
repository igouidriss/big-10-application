...
import { Table9 } from '@/shared/model/table-9.model';
...
describe('Service Tests', () => {
  describe('Table9 Service', () => {
    let service: Table9Service;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new Table9Service();
      currentDate = new Date();
      elemDefault = new Table9(
        123,
        0,
        'AAAAAAA',
        0,
    ...
    describe('Service methods', () => {
      ...
      it('should create a Table9', async () => {
        const returnedFromService = Object.assign(
          {
            id: 123,
            dateDebutResv18: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a Table9', async () => {
      ...
      it('should update a Table9', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not update a Table9', async () => {
      ...
      it('should partial update a Table9', async () => {
      ...
      it('should not partial update a Table9', async () => {
      ...
      it('should return a list of Table9', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not return a list of Table9', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a Table9', async () => {
      ...
      it('should not delete a Table9', async () => {
