...
import { type ITable8, Table8 } from '@/shared/model/table-8.model';
...
export default defineComponent({
  ...
  setup() {
    ...
    const table8: Ref<ITable8> = ref(new Table8());
    ...
    const v$ = useVuelidate(validationRules, table8 as any);
    v$.value.$validate();
      ...
      if (this.table8.id) {
        this.table8Service()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('big10SampleApplicationApp.table8.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.table8Service()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('big10SampleApplicationApp.table8.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
