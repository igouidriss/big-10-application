...
import { Table10 } from '@/shared/model/table-10.model';
...
describe('Service Tests', () => {
  describe('Table10 Service', () => {
    let service: Table10Service;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new Table10Service();
      currentDate = new Date();
      elemDefault = new Table10(
        123,
        0,
        'AAAAAAA',
        0,
    ...
    describe('Service methods', () => {
      ...
      it('should create a Table10', async () => {
        const returnedFromService = Object.assign(
          {
            id: 123,
            dateDebutResv18: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a Table10', async () => {
      ...
      it('should update a Table10', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not update a Table10', async () => {
      ...
      it('should partial update a Table10', async () => {
      ...
      it('should not partial update a Table10', async () => {
      ...
      it('should return a list of Table10', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not return a list of Table10', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a Table10', async () => {
      ...
      it('should not delete a Table10', async () => {
