...
import { type ITable10, Table10 } from '@/shared/model/table-10.model';
...
export default defineComponent({
  ...
  setup() {
    ...
    const table10: Ref<ITable10> = ref(new Table10());
    ...
    const v$ = useVuelidate(validationRules, table10 as any);
    v$.value.$validate();
      ...
      if (this.table10.id) {
        this.table10Service()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('big10SampleApplicationApp.table10.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.table10Service()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('big10SampleApplicationApp.table10.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
