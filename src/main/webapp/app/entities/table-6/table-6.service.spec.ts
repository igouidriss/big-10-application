...
import { Table6 } from '@/shared/model/table-6.model';
...
describe('Service Tests', () => {
  describe('Table6 Service', () => {
    let service: Table6Service;
    let elemDefault;
    let currentDate: Date;

    beforeEach(() => {
      service = new Table6Service();
      currentDate = new Date();
      elemDefault = new Table6(
        123,
        0,
        'AAAAAAA',
        0,
    ...
    describe('Service methods', () => {
      ...
      it('should create a Table6', async () => {
        const returnedFromService = Object.assign(
          {
            id: 123,
            dateDebutResv18: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a Table6', async () => {
      ...
      it('should update a Table6', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not update a Table6', async () => {
      ...
      it('should partial update a Table6', async () => {
      ...
      it('should not partial update a Table6', async () => {
      ...
      it('should return a list of Table6', async () => {
        const returnedFromService = Object.assign(
          {
            numLigne1: 1,
            resort2: 'BBBBBB',
      ...
      it('should not return a list of Table6', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a Table6', async () => {
      ...
      it('should not delete a Table6', async () => {
